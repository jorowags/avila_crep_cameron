...
![Figure 1](scatterplot.png)

*Figure 1: Deck choice frequency by perceived efficacy.*
...
In the original paper, the authors examined whether there was an interactive effect on deck selection between time course (early versus late trials) and aversiveness, efficacy, and effort. XXX INSERT RESULTS XXX
...
None of the fatigue subscales were significantly correlated with any of the indices. XXX INSERT RESULTS XXX
